<%--@page import="com.model3.mvc.service.domain.Product"--%>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="105"><input type="text" name="prodName"
								...
								maxLength="20" value="${product.prodName}<%--=product.getProdName()--%>"></td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="prodDetail"
					value="${product.prodDetail}<%--=product.getProdDetail()--%>" class="ct_input_g"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" readonly="readonly"
					name="manuDate" value="${product.manuDate}<%--=product.getManuDate()--%>" class="ct_input_g"
					style="width: 100px; height: 19px" maxLength="10" minLength="6">&nbsp;
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="price"
					value="${product.price}<%--=product.getPrice()--%>" class="ct_input_g"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="fileName"
					...
					maxLength="13" value="${product.fileName}<%--=product.getFileName()--%>" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="/images/ct_btnbg02.gif" class="ct_btn01"
								...
								href="javascript:fncUpdateProduct();">수정</a></td>
